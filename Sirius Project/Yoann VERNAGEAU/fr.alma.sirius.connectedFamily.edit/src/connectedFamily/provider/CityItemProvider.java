...
/**
 * This is the item provider adapter for a {@link connectedFamily.City} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CityItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConnectedFamilyPackage.Literals.CITY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConnectedFamilyPackage.Literals.CITY__FAMILIES);
			childrenFeatures.add(ConnectedFamilyPackage.Literals.CITY__ROUTERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConnectedFamilyPackage.Literals.CITY__FAMILIES,
				 ConnectedFamilyFactory.eINSTANCE.createFamily()));

		newChildDescriptors.add
			(createChildParameter
				(ConnectedFamilyPackage.Literals.CITY__ROUTERS,
				 ConnectedFamilyFactory.eINSTANCE.createMetropolitanRouter()));
	}
