...
/**
 * This is the item provider adapter for a {@link connectedFamily.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConnectedFamilyPackage.Literals.PERSON__SURNAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Person)object).getSurname();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Person.class)) {
			case ConnectedFamilyPackage.PERSON__SURNAME:
